...
[There's a demo setup for vagrant](/v1.3/setup/vagrant-setup) if you're keen on testing tTyk and tyk dashboard without having to muddle through 
...
file you can see more details [here](/v1.3/setup/confguration/).

## Step 2: Unzip the Tyk Dashboard tarball
 
First off, we need to extract the tarball, this is pretty straightforward:
    
    vagrant@precise64:~$ tar -xvzf tyk-dashboard-amd64-v0.9.tar.gz
    vagrant@precise64:~$ cd tyk-analytics-v0.9
...
Tyk dashboard is very easy to run, and takes no additional requirements to start up, to start the server simply typ the following into your command line:
    ...
    vagrant@precise64:~/tyk-analytics-v0.9$ ./tyk-analytics
    
If you have a license:

    vagrant@precise64:~/tyk-analytics-v0.9$ ./tyk-analytics --license=license.dat
