...
If you are using one of our debian packages - you can use `dpkg` to install the application using:
    ...
    martin@vyr ~/> sudo dpkg -i tyk.linux.amd64_1.5-1_all.deb
...
If you are using the tarballs, copy them to a new folder and run:
    ...
    martin@vyr ~/tyk/> tar xvzf tyk.linux.amd64_1.5-1_all.tar.gz
...
**Next**: Head on over to the [configuration](../v1.5/setup/confguration) section to see a breakdown of all of the options in the configuration file.