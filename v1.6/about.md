...
* **Request transformations** - Use simple templates to transform body request data and add or remove headers on-the-fly upstream to your API
...
* **API Documentation** The new Tyk Portal supports both API Blueprint and Swagger documentation generation that is fully tempalteable.
