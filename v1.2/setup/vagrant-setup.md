...
because that is the fastest method:
    ...
    vagrant@precise64:~$ wget http://bit.ly/tyk-v1-2-amd64-deb
    vagrant@precise64:~$ sudo dpkg -i tyk.linux.amd64_1.2-1_all.deb
...
Lets get the dashboard tarball and get everything up and running
    ...
    vagrant@precise64:~$ wget http://bit.ly/tyk-dashboard-v-0-7-1-amd64-tar-gz
